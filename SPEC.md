...
- [x] **中文 prompt 模板库**：16 个一键模板（物理 8 + 数学 8，含 2 个 3D 场景）
...
`<TemplateGallery>` 组件展示如下卡片，点击即注入对应 prompt 直接发送（共 **16 个**：物理 8 + 数学 8，含 2 个 3D 场景）：
...
- 🪀 单摆 — 小角近似周期摆动
- 🌀 弹簧振子 — 简谐振动 + 振动图线
- 🌊 横波传播 — 行波 y=A·sin(kx−ωt)
- 🧲 偶极子电场 — 电场矢量网格
- 🔍 凸透镜成像 — 三条特殊光线
- 📐 斜面受力 — 重力 / 支持力 / 摩擦力

**数学（8，含 3D）**
- 〰️ 正弦函数族 — y=A·sin(kx+φ)
